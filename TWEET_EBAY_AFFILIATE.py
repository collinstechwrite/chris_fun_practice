            ...
            for itemID in extractEbayItemIDFromWebsite:
                ...
                if price >= float(priceinput) and watchers >= int(watchersinput) and mostSold >= int(mostSoldinput) and mostSoldinhours >= int(mostSoldinhoursvar):
                    ...
                    if mostSold > 2000 and mostSoldinhours > 2:
                        ...
                        print(str(itemID), file=open(myfile, 'a'))
                        ...
                        if "apple" or "Apple" in title:
                            ...
                            print(Fore.RED + "{} #{} #{} #{}, {} Watchers, {} ${} http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=2&pub=5575036718&toolid=10001&campid={}&customid=&icep_item={}&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg ".format(MyRandomPhrases[num],title,str(tag1),str(tag2),watchers,MyRandomPrices[num2],price,yourebaycampaignID,itemID))
                        ...
                        print(Fore.RED + "{} #{} #{} #{}, {} Watchers, http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=2&pub=5575036718&toolid=10001&campid={}&customid=&icep_item={}&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg ".format(MyRandomPhrases[num],title,str(tag1),str(tag2),watchers,yourebaycampaignID,itemID))
